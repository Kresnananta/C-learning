...
void isi_bebek_ke_dalam_kandang(int nomorKandangAwal, int nomorKandangAkhir, int jumlahBebek){
    for(int i = nomorKandangAwal; i <= nomorKandangAkhir; i++){
        bebek[i] = bebek[i] + jumlahBebek;
    }
}
